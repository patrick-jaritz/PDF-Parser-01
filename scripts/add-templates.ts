...
const templates = [
  ...
  {
    name: 'Resume/CV',
    description: 'Extract resume information including personal details, education, work experience, and skills',
    template_schema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Extract meeting notes including attendees, agenda items, decisions, and action items',
    template_schema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Extract product catalog information including items, prices, and specifications',
    template_schema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Extract property listing details including features, price, and specifications',
    template_schema: {
      type: 'object',
      properties: {
...
async function addTemplates() {
  console.log(`\n🚀 Adding ${templates.length} templates to database...\n`);
  ...
  console.log('Refresh your browser to see the new templates.');
  process.exit(0);
}
